...
const typeIcon = (file: string, alt: string) => (
  <img src={`/icons/${file}`} alt={alt} className="w-7 h-7 object-contain rounded" />
)
...
const connectorTypeLabels: Record<string, { label: string; icon: string | ReactNode; category?: string }> = {
  ...
  google_secops: { label: 'Google SecOps', icon: typeIcon('google-cloud.png', 'Google SecOps'), category: 'SIEM' },
  splunk: { label: 'Splunk', icon: typeIcon('splunk.png', 'Splunk'), category: 'SIEM' },
  sentinel: { label: 'Microsoft Sentinel', icon: typeIcon('azure.png', 'Microsoft Sentinel'), category: 'SIEM' },
  elastic: { label: 'Elastic Security', icon: typeIcon('elastic.png', 'Elastic Security'), category: 'SIEM' },
  sumo_logic: { label: 'Sumo Logic', icon: typeIcon('sumologic.png', 'Sumo Logic'), category: 'SIEM' },
  // EDR
  crowdstrike_falcon: { label: 'CrowdStrike Falcon', icon: typeIcon('crowdstrike.png', 'CrowdStrike'), category: 'EDR' },
  sentinelone: { label: 'SentinelOne', icon: typeIcon('sentinelone.png', 'SentinelOne'), category: 'EDR' },
  microsoft_defender: { label: 'Microsoft Defender', icon: typeIcon('microsoft.png', 'Microsoft Defender'), category: 'EDR' },
  carbon_black: { label: 'Carbon Black', icon: typeIcon('carbonblack.png', 'Carbon Black'), category: 'EDR' },
  falco: { label: 'Falco', icon: typeIcon('falco.png', 'Falco'), category: 'EDR' },
  // XDR
  cortex_xdr: { label: 'Cortex XDR', icon: typeIcon('paloalto.png', 'Cortex XDR'), category: 'XDR' },
  trend_vision_one: { label: 'Trend Vision One', icon: typeIcon('trendmicro.png', 'Trend Vision One'), category: 'XDR' },
  // Cloud Security
  aws_security_hub: { label: 'AWS Security Hub', icon: typeIcon('aws.png', 'AWS Security Hub'), category: 'Cloud Security' },
  aws_guardduty: { label: 'AWS GuardDuty', icon: typeIcon('aws.png', 'AWS GuardDuty'), category: 'Cloud Security' },
  gcp_scc: { label: 'GCP Security Command Center', icon: typeIcon('google-cloud.png', 'GCP Security Command Center'), category: 'Cloud Security' },
  azure_defender: { label: 'Azure Defender', icon: typeIcon('azure.png', 'Azure Defender'), category: 'Cloud Security' },
  wiz: { label: 'Wiz', icon: typeIcon('wiz.png', 'Wiz'), category: 'Cloud Security' },
  orca: { label: 'Orca', icon: typeIcon('orca.png', 'Orca'), category: 'Cloud Security' },
  prowler: { label: 'Prowler', icon: typeIcon('prowler.png', 'Prowler'), category: 'Cloud Security' },
  // Identity
  okta: { label: 'Okta', icon: typeIcon('okta.png', 'Okta'), category: 'Identity' },
  entra_id: { label: 'Microsoft Entra ID', icon: typeIcon('microsoft.png', 'Microsoft Entra ID'), category: 'Identity' },
  azure_ad_identity: { label: 'Azure AD Identity Protection', icon: typeIcon('microsoft.png', 'Azure AD Identity Protection'), category: 'Identity' },
  crowdstrike_identity: { label: 'CrowdStrike Identity', icon: typeIcon('crowdstrike.png', 'CrowdStrike Identity'), category: 'Identity' },
  // Email Security
  proofpoint: { label: 'Proofpoint', icon: typeIcon('proofpoint.png', 'Proofpoint'), category: 'Email Security' },
  mimecast: { label: 'Mimecast', icon: typeIcon('mimecast.png', 'Mimecast'), category: 'Email Security' },
  microsoft_defender_email: { label: 'Defender for Office 365', icon: typeIcon('microsoft.png', 'Defender for Office 365'), category: 'Email Security' },
  // Network Security
  cloudflare: { label: 'Cloudflare', icon: typeIcon('cloudflare-v2.png', 'Cloudflare'), category: 'Network' },
  darktrace: { label: 'Darktrace', icon: typeIcon('darktrace.png', 'Darktrace'), category: 'Network' },
  vectra: { label: 'Vectra', icon: typeIcon('vectra.png', 'Vectra'), category: 'Network' },
  unifi_api: { label: 'UniFi Network', icon: typeIcon('ubiquiti.png', 'UniFi Network'), category: 'Network' },
  unifi_syslog: { label: 'UniFi Network (Syslog)', icon: typeIcon('ubiquiti.png', 'UniFi Network (Syslog)'), category: 'Network' },
  // Action Connectors
  jira: { label: 'Jira', icon: typeIcon('jira.png', 'Jira') },
  slack: { label: 'Slack', icon: typeIcon('slack.png', 'Slack') },
  pagerduty: { label: 'PagerDuty', icon: typeIcon('pagerduty.png', 'PagerDuty') },
  teams: { label: 'Microsoft Teams', icon: typeIcon('microsoft.png', 'Microsoft Teams') },
  crowdstrike: { label: 'CrowdStrike (Actions)', icon: typeIcon('crowdstrike.png', 'CrowdStrike') },
  sentinelone_action: { label: 'SentinelOne (Actions)', icon: typeIcon('sentinelone.png', 'SentinelOne') },
  servicenow: { label: 'ServiceNow', icon: typeIcon('servicenow.png', 'ServiceNow') },
